...
class EstudianteController extends Controller
{
	...
	public function index()
	{
		...
		->orderBy('nombres')
		->with(['actividades', 'categoriasCertificacion', 'lineas', 'programa', 'proyectos', 'semestre', 'tipoDocumento', 'tutores'])
	...
	{
		$estudiante->load(['actividades', 'categoriasCertificacion', 'lineas', 'programa', 'proyectos', 'semestre', 'tipoDocumento', 'tutores.programa'])
